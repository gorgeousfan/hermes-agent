...
export const tr: Translations = {
  ...
  env: {
    ...
    customProviders: {
      ...
      description:
        "config.yaml içindeki providers: altında tanımlanan model sağlayıcılarını yönetin. API anahtarları key_env üzerinden .env içinde saklanır.",
      configDescription:
        "Bu kayıtlar model yönlendirmede kullanılan aynı providers: özel endpointleridir. Sırları Anahtarlar sayfasından yönetin.",
      add: "Endpoint ekle",
      edit: "Düzenle",
      endpointKey: "Sağlayıcı anahtarı",
      ...
      models: "Modeller",
      modelsHelp: "Her satıra bir model yazın veya virgülle ayırın.",
      contextLength: "Bağlam uzunluğu",
      discoverModels: "/models üzerinden modelleri keşfet",
      extraBody: "Ek istek gövdesi JSON",
      apiKey: "API anahtarı",
      apiKeyHelp:
        "İsteğe bağlı. key_env kullanılarak .env içine kaydedilir, config.yaml içine yazılmaz.",
      clearStoredKey: "Kayıtlı API anahtarını temizle",
      probe: "Modelleri yokla",
      noProviders: "Özel endpoint yapılandırılmamış.",
      active: "Aktif",
      keySet: "anahtar var",
      keyMissing: "anahtar yok",
      sourceConfig: "config anahtarı",
      sourceEnv: "env anahtarı",
      create: "Endpoint oluştur",
      update: "Endpoint güncelle",
      deleteTitle: "Özel endpoint silinsin mi?",
      deleteMessage:
        "Bu işlem providers: kaydını ve .env içindeki key_env değerini kaldırır.",
      saved: "Özel sağlayıcı kaydedildi",
      removed: "Özel sağlayıcı kaldırıldı",
      probeLoaded: "Model listesi yüklendi",
    },
  },
