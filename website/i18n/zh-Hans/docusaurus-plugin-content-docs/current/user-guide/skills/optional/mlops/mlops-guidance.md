...
使用正则表达式和语法控制 LLM 输出，保证有效的 JSON/XML/代码生成，强制结构化格式，并使用 Guidance 构建多步骤工作流 - 微软研究的约束生成框架
...
| Tags | `Prompt Engineering`, `Guidance`, `约束生成`, `Structured Output`, `JSON Validation`, `Grammar`, `Microsoft Research`, `Format Enforcement`, `Multi-Step Workflows` |
...
# 加载模型 (supports OpenAI, Transformers, llama.cpp)
...
|---------|----------|------------|----------|------|
| 正则表达式约束 | ✅ Yes | ❌ No | ✅ Yes | ✅ Yes |
| 语法支持 | ✅ CFG | ❌ No | ✅ CFG | ✅ CFG |
| Pydantic 验证 | ❌ No | ✅ Yes | ✅ Yes | ❌ No |
| 令牌修复 | ✅ Yes | ❌ No | ✅ Yes | ❌ No |
| 本地模型 | ✅ Yes | ⚠️ Limited | ✅ Yes | ✅ Yes |
| API 模型 | ✅ Yes | ✅ Yes | ⚠️ Limited | ✅ Yes |
| Pythonic 语法 | ✅ Yes | ✅ Yes | ✅ Yes | ❌ SQL-like |
