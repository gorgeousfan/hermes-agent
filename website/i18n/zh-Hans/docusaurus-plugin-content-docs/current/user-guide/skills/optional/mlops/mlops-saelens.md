---
title: "Sparse Autoencoder 训练ing"
sidebar_label: "Sparse Autoencoder 训练ing"
description: "使用 SAELens 训练和分析稀疏自编码器（SAE）的指南，将神经网络激活分解为可解释的特征"
---

{/* This page is auto-generated from the skill's SKILL.md by website/scripts/generate-skill-docs.py. Edit the source SKILL.md, not this page. */}

# Sparse Autoencoder 训练ing

使用 SAELens 训练和分析稀疏自编码器（SAE）的指南，将神经网络激活分解为可解释的特征。适用于发现可解释特征、分析叠加现象或研究语言模型中的单语义表示。
...
SAELens 是训练和分析稀疏自编码器（SAE）的主要库 — 一种将多义神经网络激活分解为稀疏、可解释特征的技术。基于 Anthropic 关于单语义性的开创性研究。
...
### Checklist
- [ ] 加载模型 with TransformerLens
- [ ] Load matching SAE for target layer
- [ ] Encode activations to sparse features
- [ ] Identify top-activating features per token
- [ ] Validate reconstruction quality

## Workflow 2: 训练ing a Custom SAE

### Step-by-Step

```python
from sae_lens import SAE, LanguageModelSAERunnerConfig, SAE训练ingRunner
...
| `LanguageModelSAERunnerConfig` | 训练ing configuration |
| `SAE训练ingRunner` | 训练ing loop manager |
...
| File | Contents |
|------|----------|
| [references/README.md](https://github.com/NousResearch/hermes-agent/blob/main/optional-skills/mlops/saelens/references/README.md) | 概述 and quick start guide |
| [references/api.md](https://github.com/NousResearch/hermes-agent/blob/main/optional-skills/mlops/saelens/references/api.md) | Complete API reference for SAE, 训练ingSAE, configurations |
...
- [训练ing a Sparse Autoencoder](https://github.com/jbloomAus/SAELens/blob/main/tutorials/training_a_sparse_autoencoder.ipynb)
