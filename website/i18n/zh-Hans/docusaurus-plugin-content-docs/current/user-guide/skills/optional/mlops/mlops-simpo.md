---
title: "Simpo 训练ing — 用于 LLM 对齐的简单偏好优化"
sidebar_label: "Simpo 训练ing"
...
用于 LLM 对齐的简单偏好优化。DPO 的无参考替代方案，性能更优（AlpacaEval 2.0 高出 6.4 分）。无需参考模型，比 DPO 更高效。适用于想要比 DPO/PPO 更简单、更快的偏好对齐训练场景。
...
| Tags | `Post-训练ing`, `SimPO`, `Preference Optimization`, `Alignment`, `DPO Alternative`, `Reference-Free`, `LLM Alignment`, `Efficient 训练ing` |
...
### Workflow 1: 训练 from base model (Mistral 7B)
...
**替代方案**:
- **OpenRLHF**: 多节点 distributed training, PPO/GRPO
