...
OpenAI 的通用语音识别模型。支持 99 种语言、转录、翻译成英语和语言识别。六种模型规模，从小（39M 参数）到大（1550M 参数）。适用于语音转文字、播客转录或多语言音频处理。最适合强大的多语言 ASR。
...
- 训练ed on 680,000 hours of audio
- MIT License
...
# 支持: en, es, fr, de, it, pt, ru, ja, ko, zh, and 89 more
```
