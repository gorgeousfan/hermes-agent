...
# In-process cache for the live model list. Cleared on process restart.
# Each entry: {"id": ..., "type": "...", "tool_calling": bool, ...}
_TINFOIL_MODEL_CACHE: list[dict[str, Any]] | None = None
    ...
    def fetch_models(
        ...
        *,
        ...
        if _TINFOIL_MODEL_CACHE is not None:
            return [m["id"] for m in _TINFOIL_MODEL_CACHE]
        ...
        try:
            ...
            _TINFOIL_MODEL_CACHE = chat_models
