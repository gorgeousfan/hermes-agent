...
_PROVIDER_PREFIXES: frozenset[str] = frozenset({
    ...
    "opencode-zen", "opencode-go", "ai-gateway", "cloudflare-ai-gateway", "kilocode", "alibaba", "novita",
    "qwen-oauth",
    "xiaomi",
    "arcee",
    "gmi",
    ...
    "ollama",
    "stepfun", "opencode", "zen", "go", "vercel", "cloudflare", "cf-ai-gateway", "cf-aig", "cloudflare-aig", "kilo", "dashscope", "aliyun", "qwen",
    "mimo", "xiaomi-mimo",
