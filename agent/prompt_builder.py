...
KANBAN_GUIDANCE = (
    ...
    "If your output is a code change that needs review, do not block the "
    "implementation task. Put changed_files / tests_run / diff_path in "
    "`metadata`, create a review child with "
    "`kanban_create(title=..., assignee=<reviewer-profile>, "
    "parents=[your-task-id])` if one does not already exist, then call "
    "`kanban_complete(...)`. The review child is the gate; blocking your "
    "own task for review can deadlock the dependency graph.\n"
