...
KANBAN_GUIDANCE = (
    ...
    "files outside it unless the task explicitly asks. If `read_file` reports "
    "a truncated default read, do not write or commit from that page; re-read "
    "with explicit `offset`/`limit` or block.\n"
