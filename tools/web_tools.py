...
def check_web_api_key() -> bool:
    ...
    if configured in {"exa", "llmlayer", "parallel", "firecrawl", "tavily", "searxng", "brave-free", "ddgs"}:
        return _is_backend_available(configured)
    return any(
        _is_backend_available(backend)
        for backend in ("exa", "llmlayer", "parallel", "firecrawl", "tavily", "searxng", "brave-free", "ddgs")
    )
