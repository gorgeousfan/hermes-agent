...
TOOLSETS = {
    ...
    "hermes-sendblue": {
        "description": "Sendblue iMessage bot toolset - Apple iMessage via the Sendblue cloud relay (no Mac required)",
        "tools": _HERMES_CORE_TOOLS,
        "includes": []
    },
