...
_PLATFORMS = [
    ...
    },
    {
        ...
        "setup_instructions": [
            ...
            "2. Authenticate the CLI: `svix login` (paste your API token from",
            "   https://dashboard.svix.com → API Tokens)",
            "3. Create a polling endpoint in the Svix dashboard, or via CLI:",
            "     svix application list",
            "     svix endpoint create <app_id> --polling",
            "   Copy the polling URL — it looks like",
            "   https://api.svix.com/api/v1/app/app_xxx/poller/poll_yyy/",
            "4. Copy the endpoint-scoped token (sk_endp_…) shown in the dashboard.",
