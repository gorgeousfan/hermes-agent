...
_DEFAULT_PROVIDER_MODELS = {
    ...
    "opencode-go": ["glm-5.1", "glm-5", "kimi-k2.6", "kimi-k2.5", "mimo-v2-pro", "mimo-v2-omni", "mimo-v2.5-pro", "mimo-v2.5", "minimax-m2.7", "minimax-m2.5", "qwen3.6-plus", "qwen3.5-plus", "deepseek-v4-pro", "deepseek-v4-flash"],
    "huggingface": [
