...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("title", "Set a title for the current session", "Session",
               args_hint="[name]"),
    CommandDef("handoff", "Hand off this session to a messaging platform, or start fresh from a handoff file", "Session",
               args_hint="<platform> | new [path] [--title ...] [--prompt ...]", subcommands=("new",), cli_only=True),
