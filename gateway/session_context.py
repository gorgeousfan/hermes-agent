...
_SESSION_BRIEFING_MODE: ContextVar = ContextVar("HERMES_BRIEFING_MODE", default=_UNSET)
...
_VAR_MAP = {
    ...
    "HERMES_BRIEFING_MODE": _SESSION_BRIEFING_MODE,
...
def set_session_vars(
    ...
    tokens = [
        ...
        _SESSION_BRIEFING_MODE.set(briefing_mode),
    ]
    return tokens
