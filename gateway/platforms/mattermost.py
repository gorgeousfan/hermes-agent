...
class MattermostAdapter(BasePlatformAdapter):
    ...
    def __init__(self, config: PlatformConfig):
        ...
        self._callback_site: Any = None

        # Approval / confirm state.
    ...
    async def _start_callback_server(self) -> None:
        ...
        logger.info(
            "Mattermost: callback server listening on http://127.0.0.1:%d",
            self._callback_port,
        )
    ...
    async def _handle_approval_callback(self, request) -> Any:
        ...
        return web.json_response({"update": {"message": f"**{label}**", "props": {}},
    ...
    async def send_exec_approval(
        ...
        try:
            ...
            await self._api_put(f"posts/{post_id}", edit_payload)
